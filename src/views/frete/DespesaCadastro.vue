    ...
    <div class="bloco1" style="margin-top: 8%;">
        ...
        <!-- <div class="columns">
            <div class="column is-offset-4 is-4"
                ...
                <input class="input" type="text" v-model="despesa.data" placeholder="Data">
            </div>
        </div> -->
...
@Component
export default class DespesaCadastro extends Vue {
    ...
    private selectUsuarioList(): void{
        this.usuarioClient.findAll().then(
            success => this.motoristaList = success.filter(i => i.grupo !== "administrador"),
