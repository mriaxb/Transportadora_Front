...
@Component
export default class ObservacaoCancelado extends Vue{
    ...
    private atualizarStatusCancelado(): void {
        this.frete.statusFrete = "cancelado"
